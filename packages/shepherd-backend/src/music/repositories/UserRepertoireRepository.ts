...
export class MusicRepertoireMongoRepository
    ...
    @failThrows500("FIND_MUSIC_REPERTOIRE_BY_USER_ID_FAILED", "Failed to find music repertoire by user_id")
    async findRepertoireByUserId(input: Parameters<TFindMusicRepertoireByUserIdFn>[0]): ReturnType<TFindMusicRepertoireByUserIdFn> {
