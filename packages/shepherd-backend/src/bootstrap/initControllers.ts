import type {IAuthController, IRegisterController} from "../auth/types/auth.api.controllers.js";
import {RegisterController} from "../auth/api/controllers/RegisterController.js";
import {AuthController} from "../auth/api/controllers/AuthController.js";
import {UserRepertoireController} from "../music/api/UserRepertoireController.js";
...
export const initControllers = (input: { useCases: any }): any => {
    ...
    try {
        ...
        const controllers = {
            ...
            userRepertoire: new UserRepertoireController(),
