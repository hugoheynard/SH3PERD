...
import {resolveMiddlewares} from "../fnOld/resolveMiddlewares.js";
...
describe('resolveMiddlewares', () => {
    ...
    it('should throw on invalid entry', async () => {
        const badEntry = { notMiddleware: true } as unknown as TMiddlewareEntry;
        await expect(
