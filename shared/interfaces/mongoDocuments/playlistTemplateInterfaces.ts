...
export interface PlaylistTemplateDocument {
    _id: ObjectId;
    name: string;
    usage: 'daily' | 'event';
...
type Performers = (SingersEnabled | SingersDisabled) & (MusiciansEnabled | MusiciansDisabled) & (AerialEnabled | AerialDisabled);