...
import type { TPlatformRole, TQuotaResource, TQuotaPeriod } from '@sh3pherd/shared-types';

// Re-export for backward compatibility — existing imports from this file still work.
export type { TQuotaResource, TQuotaPeriod } from '@sh3pherd/shared-types';
...
export const PLAN_QUOTAS: Record<TPlatformRole, TQuotaLimit[]> = {
  ...
  artist_free: [
    ...
    { resource: 'track_version', period: 'lifetime', limit: 2 }, // per user, lifetime — cumulative even after deletion until released
  ...
  artist_pro: [
    ...
    { resource: 'track_version', period: 'lifetime', limit: 5 }, // per user, lifetime — cumulative even after deletion until released
