 ...
 */
export type TUseCaseContext<Mode extends 'scoped' | 'unscoped' = 'unscoped'> =
  Mode extends 'scoped'
    ? { user_scope: TUserId; contract_scope: TContractId; }
    : { user_scope: TUserId; };

export type Exact<TExpected, TActual extends TExpected> =
 ...
 */
export type TUseCaseInput<
  TDTO,
  Mode extends 'scoped' | 'unscoped' = 'unscoped'
> = {
  context: Exact<
