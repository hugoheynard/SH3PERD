...
export interface IUserGroupsMongoRepository extends IBaseCRUD<TUserGroupRecord>{
  getContractScopedUserGroups: (contract_scope: TContractId) => Promise<TUserGroupRecord[]>;
}


export class UserGroupsMongoRepository
  extends BaseMongoRepository<TUserGroupRecord> {
