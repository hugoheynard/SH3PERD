import type {
    ...
    TFindRefreshTokenFn, TGenerateAuthTokenFn, TGenerateRefreshTokenCookie,
    TSaveRefreshTokenFn, TVerifyAuthTokenFn
...
import type {
    ...
    TRevokeRefreshTokenResult, TSecureCookieConfig
