 ...
 */
export class AerialTagGenerator extends PlaylistTagGenerator<{ aerialConfig: TAerialConfig; numberOfSongs: number }> {
    /**
     * Aerial configuration used to generate tags.
     */
    private aerialConfig: TAerialConfig = {} as TAerialConfig;
    /**
