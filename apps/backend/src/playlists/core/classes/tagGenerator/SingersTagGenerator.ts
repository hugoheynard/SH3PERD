...
export class SingersTagGenerator extends PlaylistTagGenerator<{ singersConfig: TSingersConfig; numberOfSongs: number }> {
    private numberOfSongs: number;
    private singersConfig: TSingersConfig = {} as TSingersConfig;
