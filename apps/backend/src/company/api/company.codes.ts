...
export const COMPANY_CODES_SUCCESS = {
  ...
  UPDATE_ORG_LAYERS: { code: 'ORG_LAYERS_UPDATED', message: 'Org layers updated successfully.' },
  CONNECT_INTEGRATION: {
    code: 'INTEGRATION_CONNECTED',
    message: 'Platform integration connected.',
  },
  DISCONNECT_INTEGRATION: {
    code: 'INTEGRATION_DISCONNECTED',
    message: 'Platform integration disconnected.',
  },
  ADD_CHANNEL: { code: 'CHANNEL_ADDED', message: 'Channel added successfully.' },
  REMOVE_CHANNEL: { code: 'CHANNEL_REMOVED', message: 'Channel removed successfully.' },
  ...
  REMOVE_ORGNODE_MEMBER: {
    code: 'ORGNODE_MEMBER_REMOVED',
    message: 'Member removed from org node.',
  },
  ...
  REMOVE_GUEST_MEMBER: {
    code: 'GUEST_MEMBER_REMOVED',
    message: 'Guest member removed from org node.',
  },
