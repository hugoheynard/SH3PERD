...
export const COMPANY_CODES_SUCCESS = {
  ...
  CONNECT_INTEGRATION:   { code: 'INTEGRATION_CONNECTED',    message: 'Platform integration connected.' },
  DISCONNECT_INTEGRATION:{ code: 'INTEGRATION_DISCONNECTED', message: 'Platform integration disconnected.' },
