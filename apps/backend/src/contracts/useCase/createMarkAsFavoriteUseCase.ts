import type {
  TMarkAsFavoriteUseCase,
  TMarkAsFavoriteUseCaseDeps,
} from '../types/contracts.useCases.types.js';

export const createMarkAsFavoriteUseCase = (
  deps: TMarkAsFavoriteUseCaseDeps,
): TMarkAsFavoriteUseCase => {
