...
import type { IUserCredentialsRepository } from '../repository/UserCredentialsMongoRepository.js';
...
export class GetUserMeUseCase {
  constructor(@Inject(USER_CREDENTIALS_REPO) private readonly userCredsRepo: IUserCredentialsRepository) {}
