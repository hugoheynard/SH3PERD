...
import type { TVersionTrackDomainModel, TAudioAnalysisSnapshot, TVersionTrackId } from '@sh3pherd/shared-types';
...
export class VersionTrackVO extends ValueObject<TVersionTrackDomainModel> {
  ...
  get id(): TVersionTrackId { return this.props.id; }
  get fileName(): string { return this.props.fileName; }
  get durationSeconds(): number | undefined { return this.props.durationSeconds; }
  get uploadedAt(): number { return this.props.uploadedAt; }
  get analysisResult(): TAudioAnalysisSnapshot | undefined { return this.props.analysisResult; }
  get isFavorite(): boolean { return this.props.favorite; }
  get quality(): number | undefined { return this.props.analysisResult?.quality; }
