...
wsMenu_staffMember.addButton(
    ...
    new Icon(
        {
            css:'menuIcons',
            publicURL: '../Frontend/Public/Icones/appMenus/staffMemberMenu/staffMemberHome.svg',
            alt:'staffHome'
        }
    ),
...
wsMenu_staffMember.addButton(
    ...
    new Icon(
        {
            css:'menuIcons',
            publicURL: '../Frontend/Public/Icones/appMenus/staffMemberMenu/staffMemberInfos.svg',
            alt:'staffInfos'
        }
    ),
...
wsMenu_staffMember.addButton(
    ...
    new Icon(
        {
            css:'menuIcons',
            publicURL: '../Frontend/Public/Icones/appMenus/staffMemberMenu/staffMemberContracts.svg',
            alt:'staffContracts'
        }
    ),
...
wsMenu_staffMember.addButton(
    ...
    new Icon(
        {
            css:'menuIcons',
            publicURL: '../Frontend/Public/Icones/appMenus/staffMemberMenu/staffMemberDocuments.svg',
            alt:'staffDocs'
        }
    ),
