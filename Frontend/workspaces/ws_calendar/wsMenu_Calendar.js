...
import {CalendarMenuAction} from "./planningClasses/CalendarMenuAction.js";
...
wsMenu_Calendar.addButton(
    {
        ...
        content: new Icon(
            {
                css: 'menuIcons',
                publicURL: '../Frontend/Public/Icones/appMenus/calendarMenu/viewIndiv.svg',
                alt: 'vI'
            }
        ),
...
wsMenu_Calendar.addButton(
    {
        ...
        content: new Icon(
            {
                css: 'menuIcons',
                publicURL: '../Frontend/Public/Icones/appMenus/calendarMenu/viewCat.svg',
                alt: 'vI'
            }
        ),
...
wsMenu_Calendar.addButton(
    {
        ...
        content: new Icon(
            {
                css: 'menuIcons',
                publicURL: '../Frontend/Public/Icones/appMenus/calendarMenu/viewAll.svg',
                alt: 'vI'
            }
        ),
...
wsMenu_Calendar.addButton(
    {
        ...
        content: new Icon(
            {
                css: 'menuIcons',
                publicURL: '../Frontend/Public/Icones/appMenus/calendarMenu/addEvent.svg',
                alt: 'vI'
            }
        ),
...
wsMenu_Calendar.addButton(
    {
        ...
        content: new Icon(
            {
                css: 'menuIcons',
                publicURL: '../Frontend/Public/Icones/appMenus/calendarMenu/addTimeFrame.svg',
                alt: 'vI'
            }
        ),
