...
//import {EventGridPositionCalculator} from "../tools/calendar/EventGridPositionCalculator";
...
export const calendarService = (input: CalendarServiceInput): CalendarService => {
    ...
    return {
        async getCalendarData(input: any): Promise<any> {
            ...
            const plannings: Plannings[] = planningObjectBuilder({ users: users, calendarEvents: events });
