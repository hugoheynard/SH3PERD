...
musicLibraryRouter.post('/musicLibrary/createTrack', async (req, res) => {
...
musicLibraryRouter.put('/musicLibrary/id/:id/addVersion/', async (req, res) => {
...
musicLibraryRouter.delete('/musicLibrary/id/:id', async (req, res) => {
    try {
...
musicLibraryRouter.post('/musicLibrary/uploadMusic', async (req, res) => {
    upload(req, res, (err) => {
        if (err) {
...
export {musicLibraryRouter};

 */ 
//# sourceMappingURL=musicLibraryRouter.js.map